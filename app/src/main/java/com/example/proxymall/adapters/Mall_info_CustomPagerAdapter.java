...
import com.example.proxymall.activities.mallInfo;
import com.squareup.picasso.Picasso;


public class Mall_info_CustomPagerAdapter extends PagerAdapter {
    ...
    public Mall_info_CustomPagerAdapter(Context context) {
        mContext = context;
    ...
    @Override
    public int getCount() {
        return mallInfo.Imageurls.size();
    }
...
//            public void run() {
             ...
             //   index = index % mResources.length;
                ...
                if(index== mallInfo.Imageurls.size()){
                    index=0;
                }
        ...
        Picasso.with(mContext)
                .load(mallInfo.Imageurls.get(index))
                .into(imageView);
